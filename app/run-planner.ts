...
export type OptionalRuneBoss = {
  ...
  mapLayer?: "surface" | "underground" | "shadow";
...
export function recommendedOptionalBossLevel(boss: OptionalRuneBoss): number {
  return boss.recommendedLevel ?? (OPTIONAL_BOSS_LEVEL_BASE[boss.chapterId] ?? 80) + (boss.difficulty - 1) * 5;
}
...
export const OPTIONAL_RUNE_BOSSES: readonly OptionalRuneBoss[] = [
  ...
  { id: "night-cavalry-weeping", chapterId: "weeping", name: "Night's Cavalry", location: "Castle Morne Rampart", mapQuery: "Night's Cavalry (Weeping Peninsula)", runes: 3_400, difficulty: 2, directions: "Rest at Castle Morne Rampart and pass time until night. Fight the rider on the road in front of the grace; keep the nearby giant out of the fight and punish after the horse charges past." },
  { id: "avatar-weeping", chapterId: "weeping", name: "Erdtree Avatar", location: "Weeping Peninsula Minor Erdtree", mapQuery: "Erdtree Avatar (Weeping Peninsula)", runes: 3_600, difficulty: 2, directions: "Approach the Minor Erdtree from the Tombsward side after completing the peninsula caves. Fight on open ground, stay behind the Avatar and sprint sideways when the golden projectiles begin." },
  { id: "deathbird-weeping", chapterId: "weeping", name: "Deathbird", location: "North-west of Castle Morne", mapQuery: "Deathbird (Weeping Peninsula)", runes: 3_900, difficulty: 2, directions: "Pass time until night, then ride to the ruins on the cliff north-west of Castle Morne. Use Sacred Blade or Holy Water Pots and attack the head after its long recovery animations." },
  ...
  { id: "darriwil", chapterId: "stormveil", name: "Bloodhound Knight Darriwil", location: "Forlorn Hound Evergaol", mapQuery: "Forlorn Hound Evergaol", runes: 1_900, difficulty: 2, directions: "Enter the evergaol south of Agheel Lake South. If Blaidd's Mistwood howl steps were completed, use his gold summon sign inside; otherwise dodge through Darriwil's sweeping attacks and punish the landing." },
  ...
  { id: "night-cavalry-limgrave", chapterId: "stormveil", name: "Night's Cavalry", location: "Agheel Lake North bridge", mapQuery: "Night's Cavalry (Limgrave)", runes: 2_400, difficulty: 2, directions: "At night, clear the soldiers from the bridge south-east of Agheel Lake North, then draw the rider onto the open road. Attack after its glaive sweep or dismount it with repeated heavy attacks." },
  { id: "deathbird-limgrave", chapterId: "stormveil", name: "Deathbird", location: "East of Warmaster's Shack", mapQuery: "Deathbird (Stormhill)", runes: 2_800, difficulty: 2, directions: "Pass time until night at Warmaster's Shack and ride east to the stone ruins. Trigger the bird away from the trolls and use Sacred Blade or Holy Water Pots against its head." },
  { id: "tree-sentinel", chapterId: "stormveil", name: "Tree Sentinel", location: "Church of Elleh road", mapQuery: "Tree Sentinel", runes: 3_200, difficulty: 2, directions: "Return to the road between The First Step and Church of Elleh once the party has upgraded weapons. Fight mounted in the open field and punish after the halberd slam rather than trading into the shield." },
  ...
  { id: "night-cavalry-liurnia", chapterId: "academy", name: "Night's Cavalry", location: "Gate Town Bridge", mapQuery: "Night's Cavalry (Liurnia)", runes: 5_600, difficulty: 2, directions: "Pass time until night at Gate Town Bridge and ride south-east down the road. Draw the rider away from other enemies and punish the recovery after its glaive charge." },
  { id: "avatar-liurnia", chapterId: "caria", name: "Erdtree Avatar", location: "South-west Liurnia Minor Erdtree", mapQuery: "Minor Erdtree (Liurnia Southwest)", runes: 5_800, difficulty: 2, directions: "Ride to the Minor Erdtree west of the Converted Tower. Stay behind the Avatar, avoid fighting on the broken ground and sprint sideways through the golden projectile sequence." },
  ...
  { id: "hugues", chapterId: "caelid", name: "Battlemage Hugues", location: "Sellia Evergaol", mapQuery: "Battlemage Hugues", runes: 7_800, difficulty: 2, directions: "After lighting Sellia's three rooftop braziers, ride south-west to Sellia Evergaol. Rush Hugues during long spell casts and retreat when the Haima hammer appears." },
  { id: "oneil", chapterId: "caelid", name: "Commander O'Neil", location: "Swamp of Aeonia", mapQuery: "Commander O'Neil", runes: 12_000, difficulty: 2, directions: "Ride into the eastern Swamp of Aeonia and fight from Torrent. Remove the summoned soldiers first, then circle O'Neil and punish the end of his slow halberd strings while avoiding the scarlet-rot wind." },
  { id: "putrid-avatar-caelid", chapterId: "caelid", name: "Erdtree Avatar", location: "Minor Erdtree (Caelid)", mapQuery: "Erdtree Avatar (Caelid)", runes: 9_600, difficulty: 3, directions: "Approach the Minor Erdtree north-east of Smoldering Church only during the Caelid chapter. Stay behind the Avatar, disengage from the scarlet-rot slam and sprint sideways through its golden bolts." },
  ...
  { id: "troll-old-altus", chapterId: "altus", name: "Stonedigger Troll", location: "Old Altus Tunnel", mapQuery: "Old Altus Tunnel", runes: 9_600, difficulty: 1, directions: "Use two Stonesword Keys at Old Altus Tunnel north of Erdtree-Gazing Hill. Take the lifts to the bottom, clear the explosive-barrel rooms and use strike damage against the Troll." },
  ...
  { id: "golem-highroad", chapterId: "first-steps", name: "Guardian Golem", location: "Highroad Cave", mapQuery: "Highroad Cave", runes: 1700, difficulty: 2, recommendedLevel: 20, source: "https://eldenring.wiki.fextralife.com/Guardian+Golem", directions: "From Saintsbridge, use the spiritspring to reach the river below and follow it north to Highroad Cave. Descend the ledges inside and follow the waterfall platforms to the boss cavern. Strike the glowing ankles with charged attacks, then take the critical hit when the golem falls." },
  { id: "watchdog-impalers", chapterId: "weeping", name: "Erdtree Burial Watchdog", location: "Impaler's Catacombs", mapQuery: "Impaler's Catacombs", runes: 2400, difficulty: 2, source: "https://eldenring.wiki.fextralife.com/Erdtree+Burial+Watchdog", directions: "From Bridge of Sacrifice follow the eastern coastal cliffs north to the catacomb door. Step on the rising floor and move off it, drop underneath, then follow the passage to the lever. In the boss room kill the accompanying imps before concentrating on the Watchdog." },
  { id: "watchdog-cliffbottom", chapterId: "liurnia-south", name: "Erdtree Burial Watchdog", location: "Cliffbottom Catacombs", mapQuery: "Cliffbottom Catacombs", runes: 3200, difficulty: 2, source: "https://eldenring.wiki.fextralife.com/Erdtree+Burial+Watchdog", directions: "Follow eastern Liurnia's lower cliff path south to Cliffbottom Catacombs. Descend past the stairs, use the lower passage and ladder to reach the lever, then return to the boss door. Avoid trading with the Omen enemies on the way; dodge the Watchdog's suspended slam before attacking." },
  { id: "shade-blackknife", chapterId: "academy", name: "Cemetery Shade", location: "Black Knife Catacombs", mapQuery: "Black Knife Catacombs", runes: 3500, difficulty: 1, source: "https://eldenring.wiki.fextralife.com/Cemetery+Shade", directions: "From Ruined Labyrinth follow the north-east cliff road to Black Knife Catacombs. Ride a guillotine up, follow the upper passage and drop behind the locked gate to pull the lever. Return to the main boss door near the entrance; this Shade is separate from the hidden Black Knife Assassin quest fight. Remove its skeleton helpers before attacking." },
  { id: "crystalians-academy-cave", chapterId: "academy", name: "Crystalians", location: "Academy Crystal Cave", mapQuery: "Academy Crystal Cave", runes: 3300, difficulty: 2, source: "https://eldenring.wiki.fextralife.com/Crystalians", directions: "Use two Stonesword Keys at the cave on the academy's western lake-level cliff. Follow the cave through the sorcerer rooms to the duo. Break each crystal shell with strike damage or repeated charged attacks. This is Academy Crystal Cave, not the bell-bearing mine on the north-east shore." },
  { id: "revenant-kingsrealm", chapterId: "caria", name: "Royal Revenant", location: "Kingsrealm Ruins", mapQuery: "Kingsrealm Ruins", runes: 3100, difficulty: 3, source: "https://eldenring.wiki.fextralife.com/Royal+Revenant", directions: "On the road south of Iji, roll over the illusory floor in the north-eastern ruins to reveal the cellar stairs. Use an area healing incantation near the Revenant if your build can cast one; otherwise dodge toward its sides rather than backing into the poison. This is a harder alternative, not the default easy rune fight." },
  { id: "onyx-royal-grave", chapterId: "caria", name: "Onyx Lord", location: "Royal Grave Evergaol", mapQuery: "Royal Grave Evergaol", runes: 3600, difficulty: 2, prerequisiteLabel: "Defeat Royal Knight Loretta", source: "https://eldenring.wiki.fextralife.com/Onyx+Lord", directions: "After defeating Royal Knight Loretta, leave Caria Manor through its rear exit and head east to Royal Grave Evergaol. Standard co-op players must fight inside separately. Dodge the gravity pull and punish the end of the sword combination." },
  { id: "shade-caelid", chapterId: "caelid", name: "Cemetery Shade", location: "Caelid Catacombs", mapQuery: "Caelid Catacombs", runes: 6800, difficulty: 1, source: "https://eldenring.wiki.fextralife.com/Cemetery+Shade", directions: "Follow the coast south of the Cathedral of Dragon Communion to the catacomb entrance. Cross the rot rooms using the dry edges, reveal the illusory wall below the central stairs and pull the lever. Return to the entrance boss door; interrupt the Shade's grab preparation and attack between teleports." },
  { id: "deathrite-caelid", chapterId: "caelid", name: "Death Rite Bird", location: "Southern Aeonia Swamp Bank", mapQuery: "Death Rite Bird (Caelid)", runes: 15000, difficulty: 3, source: "https://eldenring.wiki.fextralife.com/Death+Rite+Bird", directions: "Pass time until night at Southern Aeonia Swamp Bank and cross the road to the south-east. Use Holy damage if available and leave the ghostflame patches immediately. Its damage is high for this chapter, so choose the catacomb fights instead if you are struggling." },
  { id: "gilika-lux", chapterId: "altus", name: "Demi-Human Queen Gilika", location: "Lux Ruins", mapQuery: "Lux Ruins", runes: 8500, difficulty: 1, source: "https://eldenring.wiki.fextralife.com/Demi-Human+Queen+Gilika", directions: "From Erdtree-Gazing Hill walk uphill into Lux Ruins and descend the cellar at the back. Stay close to Gilika's flank, punish the end of her staff attacks and collect the Ritual Sword Talisman from the room beyond." },
  { id: "garris-sages", chapterId: "altus", name: "Necromancer Garris", location: "Sage's Cave", mapQuery: "Sage's Cave", runes: 9000, difficulty: 1, source: "https://eldenring.wiki.fextralife.com/Necromancer+Garris", directions: "From Abandoned Coffin ride north-east along the shallow lake to Sage's Cave. Strike the illusory walls and follow the treasure-lined passages to Garris's separate fog door near the waterfall. Kill the rolling skull summon first, then pressure Garris before he casts. Do not confuse this with the cave's invisible Assassin." },
  { id: "noble-writheblood", chapterId: "altus", name: "Sanguine Noble", location: "Writheblood Ruins", mapQuery: "Writheblood Ruins", runes: 8800, difficulty: 2, source: "https://eldenring.wiki.fextralife.com/Sanguine+Noble", directions: "Reach the ruins west of the Altus Minor Erdtree and descend their cellar. Do not strike into the Noble's raised-dagger parry stance. Punish its missed thrust and retreat from blood pools. This is the cellar boss, not Magnus's red invasion sign for Varre." },
  { id: "wormface-altus", chapterId: "altus", name: "Wormface", location: "Minor Erdtree (Altus Plateau)", mapQuery: "Minor Erdtree (Altus Plateau)", runes: 10000, difficulty: 2, source: "https://eldenring.wiki.fextralife.com/Wormface", directions: "From Bower of Bounty follow the road east, then north to the Minor Erdtree. Clear smaller wormfaces away from the arena. Attack the boss's rear and leave every death-blight cloud immediately; do not let the death-blight meter fill." },
  { id: "onyx-sealed", chapterId: "leyndell", name: "Onyx Lord", location: "Sealed Tunnel", mapQuery: "Sealed Tunnel", runes: 16000, difficulty: 1, recommendedLevel: 90, source: "https://eldenring.wiki.fextralife.com/Onyx+Lord", directions: "Enter Sealed Tunnel in the moat outside the capital. Continue past the first-chamber bell-bearing chest, reveal the illusory walls and descend the roots and shafts to the boss. His defeat is not required to obtain that bell bearing. Dodge the sword chain, then close in after the gravity attack." },
  { id: "margot-volcano", chapterId: "gelmir", name: "Demi-Human Queen Margot", location: "Volcano Cave", mapQuery: "Volcano Cave", runes: 11000, difficulty: 1, recommendedLevel: 85, source: "https://eldenring.wiki.fextralife.com/Demi-Human+Queen+Margot", directions: "From Ninth Mt. Gelmir Campsite follow the northern cliff path to Volcano Cave; do not enter the Full-Grown Fallingstar Beast crater. Descend the cave, pass the demi-humans and fight Margot in its final cavern. Keep to her flank and avoid the front of the roar." },
  { id: "maggie-hermit", chapterId: "gelmir", name: "Demi-Human Queen Maggie", location: "Hermit Village", mapQuery: "Hermit Village", runes: 13000, difficulty: 2, recommendedLevel: 85, source: "https://eldenring.wiki.fextralife.com/Demi-Human+Queen+Maggie", directions: "Follow Seethewater's western circuit past the lava lake and Craftsman's Shack to Hermit Village. Clear the sorcerers before approaching Maggie near Primeval Sorcerer Azur. Fight at her side and take the Memory Stone afterward; this does not require killing Rykard." },
  { id: "rot-seethewater", chapterId: "gelmir", name: "Kindred of Rot", location: "Seethewater Cave", mapQuery: "Seethewater Cave", runes: 10000, difficulty: 2, recommendedLevel: 85, source: "https://eldenring.wiki.fextralife.com/Kindred+of+Rot", directions: "Follow Seethewater River north to the cave near the Minor Erdtree and spend two Stonesword Keys at its entrance. Bring poison-curing boluses. Descend through the poison pools to the paired pests, concentrate on one and dodge sideways through Pest Threads." },
  { id: "spiritcaller-mountains", chapterId: "mountaintops", name: "Spirit-Caller Snail", location: "Spiritcaller Cave", mapQuery: "Spiritcaller Cave", runes: 70000, difficulty: 3, recommendedLevel: 115, source: "https://eldenring.wiki.fextralife.com/Spirit-Caller+Snail", directions: "Use two Stonesword Keys at Spiritcaller Cave on the western shore of the frozen lake. Eliminate the summoning snails through the cave. At the boss door you must defeat a summoned Godskin Apostle and then a Godskin Noble before the final snail appears. This is a long, harder alternative, not a free 70,000-rune pickup." },
  { id: "deathrite-mountains", chapterId: "mountaintops", name: "Death Rite Bird", location: "West of Castle Sol", mapQuery: "Death Rite Bird (Central Mountaintops of the Giants)", runes: 77000, difficulty: 3, recommendedLevel: 120, source: "https://eldenring.wiki.fextralife.com/Death+Rite+Bird", directions: "From Castle Sol Main Gate follow the path west onto the middle plateau. This bird can appear during the day. Keep out of ghostflame patches and use Holy damage if available; leave rather than trade hits through its explosion." },
  { id: "borealis", chapterId: "mountaintops", name: "Borealis the Freezing Fog", location: "Freezing Lake", mapQuery: "Borealis the Freezing Fog", runes: 100000, difficulty: 3, recommendedLevel: 120, source: "https://eldenring.wiki.fextralife.com/Borealis+the+Freezing+Fog", directions: "Enter the frozen lake from Freezing Lake grace to trigger the fog. Bring frost-curing boluses and prefer strike damage over slash if the build permits. Sprint away from the frost roar and breath; the church and story route can be reached without winning this fight." },
  { id: "deathrite-snowfield", chapterId: "haligtree", name: "Death Rite Bird", location: "South-east of Apostate Derelict", mapQuery: "Death Rite Bird (Consecrated Snowfield)", runes: 220000, difficulty: 3, recommendedLevel: 135, source: "https://eldenring.wiki.fextralife.com/Death+Rite+Bird", directions: "After using both Haligtree medallion halves, travel to Apostate Derelict. Pass time to night and approach the frozen river south-east of the church. This is an endgame alternative with lethal ghostflame damage, not an early rune shortcut; use Holy damage and avoid the lingering ground fire." },
  { id: "onze-belurat", chapterId: "gravesite", name: "Demi-Human Swordmaster Onze", location: "Belurat Gaol", mapQuery: "Belurat Gaol", mapLayer: "shadow", runes: 80000, difficulty: 2, recommendedLevel: 150, source: "https://eldenring.wiki.fextralife.com/Demi-Human+Swordmaster+Onze", directions: "Enter Belurat Gaol at the lake west of Greatbridge, North. Descend the hanging jars and storerooms to the bottom fog gate. Gather nearby Scadutree Fragments first. Onze is fast but susceptible to stagger; let his leaping combination finish before attacking." },
  { id: "blackgaol", chapterId: "gravesite", name: "Blackgaol Knight", location: "Western Nameless Mausoleum", mapQuery: "Western Nameless Mausoleum", mapLayer: "shadow", runes: 70000, difficulty: 3, recommendedLevel: 150, source: "https://eldenring.wiki.fextralife.com/Blackgaol+Knight", directions: "From Gravesite Plain head west into the mausoleum stairs. Gather nearby Scadutree Fragments before attempting it. Sprint sideways during the crossbow volley and punish the end of the greatsword's ranged skill. Spirit Ash summons are unavailable in this arena; return later if the damage is excessive." },
  { id: "bloodfiend-rivermouth", chapterId: "ensiss", name: "Chief Bloodfiend", location: "Rivermouth Cave", mapQuery: "Rivermouth Cave", mapLayer: "shadow", runes: 80000, difficulty: 1, recommendedLevel: 150, source: "https://eldenring.wiki.fextralife.com/Chief+Bloodfiend", directions: "From Castle Front descend the south-eastern road to the Ellac River Cave route. At the river turn upstream/north to the cave at its western bank. Follow the wolf and bloodfiend passages to the fog door. Stay to the Chief's side and punish the long recovery after its body slam." },
  { id: "marigga", chapterId: "fissure", name: "Demi-Human Queen Marigga", location: "Cerulean Coast western beach", mapQuery: "Demi-Human Queen Marigga", mapLayer: "shadow", runes: 100000, difficulty: 1, recommendedLevel: 150, source: "https://eldenring.wiki.fextralife.com/Demi-Human+Queen+Marigga", directions: "From Cerulean Coast West follow the ravine north, then turn west through its fork to the secluded beach. Clear the nearby demi-humans before approaching Marigga and attack her flank. This beach does not require entering the sealed Stone Coffin Fissure." },
] as const;
...
export function selectOptionalRuneBosses(
  ...
  const candidates = OPTIONAL_RUNE_BOSSES
    .filter((boss) => boss.chapterId === chapterId && boss.difficulty < 3 && !boss.prerequisiteLabel)
...
export function planBuildStatTarget(
  ...
  const origin = namedOrigin && namedOrigin.level <= targetRuneLevel
    ? namedOrigin : recommendOrigins(requirement).find((item) => item.origin.level <= targetRuneLevel &&
      (build.tags?.includes("tarnished-pack-required") || !["idus-knight", "heavy-knight"].includes(item.origin.id)))?.origin ?? ORIGIN_BY_ID.wretch;
