...
const chapterData: Chapter[] = [
  ...
  { id: "altus", act: "Base game", title: "Altus Supply Line", region: "Altus Plateau", level: "75–90", upgrade: "+16–19 / Somber +6–7", grace: "Altus Highway Junction", x: 55, y: 35, phase: "mid", summary: "Open the plateau, collect replacement-weapon materials, and avoid prematurely entering the capital.", essentials: ["Dectus Lift or Ruin-Strewn Precipice", "Sealed Tunnel: Smithing-Stone Miner's Bell Bearing [2]"], directions: "Use the highway junction as a hub. Sweep north to the map stone, west toward Gelmir, and east to the sealed tunnel outside Leyndell." },
  ...
  { id: "messmer", act: "Shadow of the Erdtree", title: "The Dark Chamber", region: "Shadow Keep", level: "150+", upgrade: "Max weapons", blessing: "Scadutree 14–16", grace: "Dark Chamber Entrance", x: 58, y: 38, summary: "Resolve faction summons and defeat the first mandatory DLC lord.", essentials: ["Finish Ansbach and Freyja letter exchange", "Resolve Leda/Hornsent summon choices", "Defeat Messmer"], directions: "Return to the Specimen Storehouse, climb the exterior statues and upper lofts, then take the final lift to the Dark Chamber.", boss: "Messmer the Impaler", remembrance: true, quest: "Faction summon choices", repeatInStandard: true },
