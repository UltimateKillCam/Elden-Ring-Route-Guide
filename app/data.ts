...
const chapterData: Chapter[] = [
  ...
  { id: "liurnia-south", act: "Base game", title: "Liurnia South", region: "Liurnia of the Lakes", level: "40–50", upgrade: "+7–10 / Somber +3–4", grace: "Lake-Facing Cliffs", x: 37, y: 47, phase: "mid", summary: "Catch replacement weapons up to the party cap, start Varre's DLC-access route and prepare the Academy key route.", essentials: ["Meet Hyetta and Thops", "Speak to Ensha at Roundtable Hold before taking a secret medallion", "Find Albus and collect Haligtree Secret Medallion (Right)", "Meet Varre at Rose Church and choose that the Fingers seemed off", "Complete three invasions or defeat Magnus at Writheblood Ruins", "Soak the Lord of Blood's Favor in maiden blood and return to Varre", "Keep the Pureblood Knight's Medal but do not use it for early farming", "Reach Iji in north-west Liurnia", "Collect Academy Glintstone Key", "Defeat the Crystalian for Smithing-Stone Miner's Bell Bearing [1]"], directions: "Descend from Lake-Facing Cliffs and use the lake shallows as a hub. Finish Varre at Rose Church, visit the Village of the Albinaurics, collect the Academy key and end at Raya Lucaria Crystal Tunnel in the north-east." },
  ...
  { id: "caria", act: "Base game", title: "Caria and Ranni", region: "West Liurnia", level: "55–65", upgrade: "+11–13 / Somber +5", grace: "Road to the Manor", x: 28, y: 35, phase: "mid", summary: "Begin Ranni's chain and perform the dialogue route that opens Radahn's Festival without entering Altus early.", essentials: ["Defeat Royal Knight Loretta", "Speak to Ranni and all three retainers", "Meet Blaidd in Siofra", "Ask Seluvis about Nokron and take his introduction", "Give Seluvis's Introduction to Sellen at Waypoint Ruins", "Return to Blaidd in Siofra and exhaust his dialogue", "Do not attack Seluvis or any quest NPC"], directions: "Clear Caria Manor, enter Ranni's service, then follow Blaidd's Siofra dialogue through Seluvis and Sellen. This dialogue chain moves Blaidd to Redmane Castle and activates Radahn's Festival.", boss: "Royal Knight Loretta", quest: "Ranni: oath and Radahn Festival activation", repeatInStandard: true },
  { id: "caelid", act: "Base game", title: "The Radahn Festival", region: "South Caelid", level: "60–70", upgrade: "+12–15 / Somber +5–6", grace: "Chamber Outside the Plaza", x: 72, y: 63, phase: "mid", summary: "Start Millicent safely, open Nokron and satisfy the first half of the DLC access requirement.", essentials: ["Collect Map: Caelid", "Defeat Commander O'Neil in Aeonia Swamp and take the Unalloyed Gold Needle", "Give the needle to Gowry, reload, then give the repaired needle to Millicent", "Reload Church of the Plague, exhaust Millicent, then revisit Gowry's Shack", "Collect Dectus Medallion (Right) at Fort Faroth without fighting Greyoll", "Use the sending gate at Impassable Greatbridge", "Speak to Jerren in Redmane Plaza to begin the festival", "Defeat Starscourge Radahn", "Exhaust Alexander and Blaidd in the Wailing Dunes before leaving"], directions: "Enter from Smoldering Church, finish O'Neil and Millicent's Church of the Plague steps, then follow the southern road to Impassable Greatbridge. Use the active sending gate, speak to Jerren and take the church lift to the Wailing Dunes.", boss: "Starscourge Radahn", remembrance: true, quest: "Millicent, Ranni and Alexander; DLC access requirement", repeatInStandard: true },
  ...
  { id: "altus", act: "Base game", title: "Altus Supply Line", region: "Altus Plateau", level: "75–90", upgrade: "+16–19 / Somber +6–7", grace: "Altus Highway Junction", x: 55, y: 35, phase: "mid", summary: "Open Altus, resolve Seluvis before Ranni, advance Millicent and start Goldmask without entering the capital.", essentials: ["Use both Dectus Medallion halves at the Grand Lift", "Rest at Altus Plateau grace and revisit Roundtable quest NPCs", "Collect Amber Starlight north-east of Altus Highway Junction", "Finish Seluvis's potion and puppet steps", "Give Amber Starlight to Seluvis and collect Magic Scorpion Charm", "Do not give Ranni the Amber Draught", "Give Fingerslayer Blade to Ranni and receive the Carian Inverted Statue", "Use the statue in Carian Study Hall and collect the Cursemark of Death", "Collect Valkyrie's Prosthesis from the Shaded Castle", "Give the prosthesis to Millicent at Erdtree-Gazing Hill", "Defeat the Godskin Apostle at Windmill Village and speak to Millicent", "Find Goldmask at the Forest-Spanning Greatbridge and reunite Corhyn with him", "Sealed Tunnel: Smithing-Stone Miner's Bell Bearing [2]"], directions: "Use the Grand Lift, rest at the plateau grace and complete the Seluvis detour before giving Ranni Nokron's blade. Then finish the Study Hall, Millicent and Goldmask stops before approaching the capital outskirts.", quest: "Seluvis hard lock, Millicent and Goldmask", repeatInStandard: true },
  { id: "gelmir", act: "Base game", title: "Volcano Manor — first visit", region: "Mt. Gelmir", level: "80–95", upgrade: "+18–20 / Somber +7", grace: "Volcano Manor", x: 35, y: 29, phase: "late", summary: "Join the manor, resolve Rya's pre-Juno requirements and collect every available contract without killing Rykard.", essentials: ["Join Volcano Manor and take the Drawing-Room Key", "Complete Old Knight Istvan and Rileigh contracts", "Take Bernahl's red letter after Rileigh", "Defeat Magma Wyrm Makar and complete Patches' Tragoth request", "Advance Diallos and Rya dialogue", "Defeat Godskin Noble", "Collect Serpent's Amnion and give it to Rya", "Reload, find Rya in the side room and settle the Tonic of Forgetfulness decision", "Do not defeat Rykard before Juno, Bernahl and Rya are complete"], directions: "Join Tanith and complete the first two manor letters. Take Bernahl's and Patches' requests, clear Prison Town through Godskin Noble, give Rya the Serpent's Amnion and resolve her disappearance before the Mountaintops contract. Leave Rykard alive.", quest: "Rykard is deliberately delayed to preserve Rya and every Manor reward", repeatInStandard: true },
  { id: "leyndell", act: "Base game", title: "Leyndell, Royal Capital", region: "Leyndell", level: "90–110", upgrade: "+20–22 / Somber +7–8", grace: "East Capital Rampart", x: 63, y: 37, phase: "late", summary: "Enter with two Great Runes, finish the original-capital contracts and solve Goldmask before the Ashen transition.", essentials: ["Confirm at least two Great Runes are obtained", "Defeat Draconic Tree Sentinel and enter Leyndell", "Complete Bernahl's Vargram and Wilhelm invasion in Fortified Manor", "Return to Bernahl for Gelmir's Fury", "Collect Bolt of Gransax before Maliketh", "Collect Coded Sword before Maliketh", "Collect Golden Order Principia above Erdtree Sanctuary", "Learn Law of Regression and cast it before Radagon's statue", "Tell Goldmask that Radagon is Marika", "Visit Dung Eater's projection and unlock his sewer gaol before the Ashen transition", "Defeat Godfrey's golden shade", "Defeat Morgott"], directions: "Defeat the north-east Draconic Tree Sentinel, descend from East Capital Rampart and clear the Fortified Manor contract and both legendary weapons. After Godfrey's shade, retrieve the Principia and solve Goldmask's statue message before Morgott.", boss: "Morgott, the Omen King", remembrance: true, quest: "Bernahl, Goldmask and original-capital missables", repeatInStandard: true },
  ...
  { id: "deeproot", act: "Base game", title: "Deeproot and Fia", region: "Deeproot Depths", level: "90–110", upgrade: "+20–22 / Somber +8", grace: "Across the Roots", x: 55, y: 50, summary: "Resolve Fia's chain after obtaining Ranni's Cursemark and collect Deeproot's build rewards.", essentials: ["Defeat Crucible Knight Siluria", "Give Fia the Cursemark of Death", "Exhaust Fia's dialogue and reload", "Enter the deathbed dream", "Defeat Lichdragon Fortissax"], directions: "Reach Deeproot through the Siofra Aqueduct coffin. Detour north-west to the hollow tree for Siluria, then cross the roots into the ruined city and climb the upper roots to Fia's arena.", boss: "Lichdragon Fortissax", remembrance: true, quest: "Fia quest", repeatInStandard: true },
  { id: "mountaintops", act: "Base game", title: "Mountaintops of the Giants", region: "Mountaintops", level: "105–120", upgrade: "+22–24 / Somber +8–9", grace: "Zamor Ruins", x: 68, y: 20, phase: "late", summary: "Finish the last Manor, Millicent and Goldmask stops, secure the Haligtree route and stop before the Forge world-state change.", essentials: ["Receive Rold Medallion from Melina after Morgott", "Use Grand Lift of Rold and enter the Mountaintops", "Zamor Ruins: Smithing-Stone Miner's Bell Bearing [3]", "Meet Millicent at Ancient Snow Valley Ruins", "Meet Corhyn and Goldmask on the bridge south of Stargazers' Ruins", "Complete Shabriri and Yura decisions without inheriting the Frenzied Flame by accident", "Defeat Juno Hoslow for the final Volcano Manor contract", "Defeat Commander Niall at Castle Sol", "Collect Haligtree Secret Medallion (Left)", "Defeat Fire Giant", "Do not use the Forge until the quest safety check is complete"], directions: "Use the Rold Medallion, collect the Zamor bell bearing and finish Millicent, Goldmask and Juno. Clear Castle Sol for the left secret-medallion half. Defeat Fire Giant but wait at the Forge until every pre-burning card is complete.", boss: "Fire Giant", remembrance: true, quest: "Final pre-Forge NPC checks", repeatInStandard: true },
  { id: "rykard", act: "Base game", title: "Volcano Manor — Rykard", region: "Mt. Gelmir", level: "110–125", upgrade: "+22–24 / Somber +8–9", grace: "Volcano Manor", x: 35, y: 29, phase: "late", summary: "Return only after the Mountaintops contract so no Volcano Manor reward is lost.", essentials: ["Report Juno Hoslow's defeat to Tanith", "Finish Rya's dialogue and choice", "Collect Bernahl, Patches and Tanith contract rewards", "Defeat Rykard"], directions: "Return to Volcano Manor after Juno Hoslow. Exhaust every resident's dialogue and collect each contract reward before accepting Tanith's audience and fighting Rykard with the Serpent-Hunter.", boss: "Rykard, Lord of Blasphemy", remembrance: true, quest: "Final Volcano Manor lock point", repeatInStandard: true },
  ...
  { id: "farum", act: "Base game", title: "Crumbling Farum Azula", region: "Farum Azula", level: "125–145", upgrade: "+25 / Somber +10", grace: "Dragon Temple", x: 78, y: 25, phase: "late", summary: "Enter from the Forge, finish Alexander and the final bell bearing, then make the last original-capital check before Maliketh.", essentials: ["Confirm Goldmask's Mountaintops message and every original-capital pickup are complete", "Speak to Melina at the Forge and commit to the cardinal sin", "Defeat Godskin Duo for Smithing-Stone Miner's Bell Bearing [4]", "Meet Alexander beyond the Dragon Temple Lift and finish his duel", "Find the hidden Placidusax drop-down", "Defeat Dragonlord Placidusax", "Confirm Bolt of Gransax and Coded Sword are collected", "Defeat Maliketh only after every listed check"], directions: "After the Fire Giant and quest check, use the Forge to reach Farum Azula. Defeat the Godskin Duo, finish Alexander, take the Beside the Great Bridge drop-down for Placidusax and only then approach Maliketh; his defeat permanently creates the Ashen Capital.", boss: "Maliketh, the Black Blade", remembrance: true, quest: "Alexander and the hard Ashen Capital world-state change", repeatInStandard: true },
  ...
  { id: "shadow-keep", act: "Shadow of the Erdtree", title: "Shadow Keep Crossroads", region: "Scadu Altus", level: "150+", upgrade: "Max weapons", blessing: "Scadutree 8–10", grace: "Highroad Cross", x: 57, y: 45, summary: "Resolve every post-break choice in a safe order and do not enter Messmer's arena until the bridge signs are settled.", essentials: ["Speak to Leda, Hornsent, Ansbach, Freyja, Moore, Thiollier and Dane after the rune breaks", "Choose Moore's answer only after collecting the available Forager Brood cookbooks", "Collect the O Mother gesture north of Bonny Village", "Resolve the Leda and Hornsent bridge summon signs before entering Messmer's arena", "Defeat Golden Hippopotamus", "Open Storehouse First Floor, Seventh Floor, Loft and Back Gate paths", "Speak to Freyja on the seventh floor and then tell Ansbach about her", "Give Ansbach the Secret Rite Scroll and receive the Letter for Freyja", "Deliver Ansbach's letter to Freyja and exhaust both characters", "Resolve the Leda and Ansbach Storehouse signs for the party's required reward", "Do not enter Messmer's arena until every faction card is complete"], directions: "Revisit all followers first. Collect O Mother, enter Shadow Keep and resolve Leda's bridge signs. In the Storehouse speak to Freyja first, tell Ansbach, then give him the scroll and carry his letter back. Resolve any Leda/Ansbach signs before entering Messmer.", quest: "Moore, Hornsent, Leda, Ansbach and Freyja irreversible choices", repeatInStandard: true },
  ...
  { id: "jagged", act: "Shadow of the Erdtree", title: "Jagged Peak", region: "Jagged Peak", level: "150+", upgrade: "Max weapons", blessing: "Scadutree 11–13", grace: "Jagged Peak Summit", x: 81, y: 66, summary: "Finish Igon's full quest and the dragon superboss at a fair blessing level.", essentials: ["Speak to Igon beside Pillar Path Waypoint", "Defeat Ancient Dragon-Man in Dragon's Pit", "Speak to Igon after the two drakes fight and receive his finger", "Defeat Ancient Dragon Senessax", "Use Igon's summon sign inside Bayle's arena", "Defeat Bayle the Dread", "Return to the Dragon Communion Priestess for the selected reward"], directions: "Clear Dragon's Pit to reach the Terminus, exhaust Igon's dialogue after the drake battle, climb past Senessax and summon Igon from inside Bayle's arena. Return to the Grand Altar afterward before leaving the chapter.", boss: "Bayle the Dread", quest: "Igon and Dragon Communion Priestess rewards", repeatInStandard: true },
