...
const chapterData: Chapter[] = [
  { id: "first-steps", act: "Base game", title: "First Steps", region: "West Limgrave", level: "1–15", upgrade: "+0–2 / Somber +1", grace: "The First Step", x: 34, y: 76, phase: "early", summary: "Unlock the core systems, assemble every player's first functional kit and start the Limgrave NPC chains before they move.", essentials: ["Church of Elleh: Crafting Kit and Kale", "Gatefront: Whetstone Knife and first map", "Accept Melina's accord and receive Torrent", "Meet Renna at Church of Elleh at night", "Meet Boc south-east of Agheel Lake North", "Meet Roderika at Stormhill Shack", "Clear Fort Haight and speak to Kenneth Haight", "Collect Dectus Medallion (Left) at Fort Haight", "Third Church: Flask of Wondrous Physick", "Limgrave Tunnels: early Smithing Stones"], directions: "From The First Step, ride north to Church of Elleh and Gatefront. Start Boc and Roderika, sweep east through Fort Haight and the Third Church, then return to Limgrave Tunnels." },
  { id: "weeping", act: "Base game", title: "The Weeping Peninsula", region: "Weeping Peninsula", level: "18–30", upgrade: "+3–5 / Somber +2", grace: "Castle Morne Rampart", x: 37, y: 91, phase: "early", summary: "Finish early weapon pickups, Boc's sewing tools and the complete Irina and Edgar chain.", essentials: ["Clear Coastal Cave and return Boc's Sewing Needle", "Speak to Irina before entering Castle Morne", "Give Irina's letter to Edgar before the boss", "Defeat Leonine Misbegotten", "Show Edgar the Grafted Blade Greatsword", "Return to Irina and Edgar before leaving"], directions: "Clear Coastal Cave before crossing the Bridge of Sacrifice. Speak to Irina, take her letter through Castle Morne to Edgar, defeat Leonine and report back to Edgar before returning to Irina.", boss: "Leonine Misbegotten", quest: "Boc, Irina and Edgar", repeatInStandard: true },
  { id: "stormveil", act: "Base game", title: "Stormveil Castle", region: "Stormhill & Stormveil", level: "30–40", upgrade: "+4–7 / Somber +2–3", grace: "Stormveil Main Gate", x: 28, y: 63, phase: "early", summary: "Secure the first Great Rune while preserving Gostoc, Rogier, Nepheli and Roderika's later rewards.", essentials: ["Defeat Margit", "Keep Gatekeeper Gostoc alive for his later Ancient Dragon Smithing Stone", "Collect Chrysalids' Memento for Roderika", "Collect Iron Whetblade and Misericorde", "Meet Rogier in the chapel and inspect the corpse below Stormveil", "Meet Nepheli before Godrick", "Defeat Godrick the Grafted", "Move Roderika to Roundtable Hold and unlock spirit tuning"], directions: "Take Gostoc's side path but leave him alive. Meet Rogier and Nepheli, collect Roderika's memento and inspect the face beneath the castle before Godrick. Afterward alternate Roderika and Hewg dialogue at Roundtable until spirit tuning opens.", boss: "Godrick the Grafted", remembrance: true, quest: "Gostoc, Rogier, Nepheli and Roderika", repeatInStandard: true },
  { id: "liurnia-south", act: "Base game", title: "Liurnia South", region: "Liurnia of the Lakes", level: "40–50", upgrade: "+7–10 / Somber +3–4", grace: "Lake-Facing Cliffs", x: 37, y: 47, phase: "mid", summary: "Start Varre and Latenna, preserve Ensha's missable gesture and prepare the Academy key route.", essentials: ["Meet Hyetta and give her the first Shabriri Grape", "Meet Thops at Church of Irith", "Speak to Ensha at Roundtable Hold before taking a secret medallion", "Find Albus and collect Haligtree Secret Medallion (Right)", "Clear Lakeside Crystal Cave and show Latenna the medallion", "Accept Latenna's request and receive her spirit ashes", "Meet Varre at Rose Church and choose that the Fingers seemed off", "Complete three invasions or defeat Magnus at Writheblood Ruins", "Soak the Lord of Blood's Favor in maiden blood and return to Varre", "Keep the Pureblood Knight's Medal but do not use it for early farming", "Reach Iji in north-west Liurnia", "Collect Academy Glintstone Key", "Defeat the Crystalian for Smithing-Stone Miner's Bell Bearing [1]"], directions: "Use the lake shallows as a hub. Start Hyetta and Thops, visit Albus before Latenna beyond Lakeside Crystal Cave, finish Varre at Rose Church, collect the Academy key and end at Raya Lucaria Crystal Tunnel.", quest: "Ensha, Latenna, Varre, Hyetta and Thops" },
