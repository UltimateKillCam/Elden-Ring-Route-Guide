...
const chapterData: Chapter[] = [
  { id: "first-steps", act: "Base game", title: "First Steps", region: "West Limgrave", level: "1–15", upgrade: "+0–2 / Somber +1", grace: "The First Step", x: 34, y: 76, phase: "early", summary: "Unlock the core systems, assemble every player's first functional kit and start the Limgrave NPC chains before they move.", essentials: ["Church of Elleh: Crafting Kit and Kale", "Gatefront: Whetstone Knife and first map", "Accept Melina's accord and receive Torrent", "Meet Renna at Church of Elleh at night", "Meet Boc south-east of Agheel Lake North", "Meet Roderika at Stormhill Shack", "Clear Fort Haight and speak to Kenneth Haight", "Collect Dectus Medallion (Left) at Fort Haight", "Third Church: Flask of Wondrous Physick", "Optional no-boss Fort Faroth detour: take the waygate behind Third Church to Bestial Sanctum, ride south and loot Radagon's Soreseal via the fort's roof-to-rafters route", "WARNING — Radagon's Soreseal increases all damage taken by 15%; use it only while the early stat gain outweighs the penalty, then unequip it", "Limgrave Tunnels: sweep the wall deposits and collect the finite Somber Smithing Stone [1] before leaving"], directions: "From The First Step, ride north to Church of Elleh and Gatefront. Start Boc and Roderika, then sweep east through Fort Haight and the Third Church. The Fort Faroth run is an optional no-boss loot detour: avoid combat, grab the Soreseal and fast-travel out. Finish this chapter with the Limgrave Tunnels material sweep." },
