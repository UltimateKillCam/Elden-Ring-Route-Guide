...
export const EQUIPMENT_DATA_SOURCES = [
  ...
  {
    "label": "Local Elden Ring regulation",
    "url": "https://en.bandainamcoent.eu/elden-ring/news/elden-ring-patch-notes-version-117",
    "gameVersion": "1.17 / Tarnished Pack",
    "regulationVersion": 11701000,
    "sha256": "FB4AFD25E70EFFC9F9523D3ABA89B1FB3E08B0800D8EFB9A535CAB038C5E8BBD"
  }
] as const;
...
export const ARMOUR_PIECES: readonly ArmourPiece[] = [
  ...
  {
    "name": "Silver Grooved Armor",
    "slot": "chest",
    "weight": 7.1,
    "poise": 16
  },
  {
    "name": "Silver Grooved Armor (Altered)",
    "slot": "chest",
    "weight": 6.5,
    "poise": 12
  },
  ...
  {
    "name": "Leontiel's Leather Gloves",
    "slot": "arms",
    "weight": 1.9,
    "poise": 2
  },
...
const NORMALIZED_GENERIC_ARMOUR = [
  ...
  {
    "source": "transformation \\(no armou?r\\)",
    "flags": "i"
  },
  {
